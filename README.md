...
Repositório de provas antigas da Disciplina **Sistemas Operacionais** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/sistemas-operacionais.git`
...
`git clone git@github.com:compcederj/sistemas-operacionais.git`
...
# Sistemas Operacionais
Repositório de provas antingas da Disciplina **Sistemas Operacionais** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
